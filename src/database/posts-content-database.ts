...
const PostsData: PostType[] = [
  {
    ...
    content: [
      {
        subTitle: "1. O que são variaveis no nosso querido e amado Javascript?",
        description:
      ...
      {
        subTitle: "2. Declaração de Variáveis:",
        description:
      ...
      {
        subTitle: "3. Escopo de Variáveis:",
        description:
      ...
      {
        subTitle: "4. Atribuição de Valores:",
        description:
